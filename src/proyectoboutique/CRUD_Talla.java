 ...
 * @author Tadeo
 */
public class CRUD_Talla extends javax.swing.JFrame {

    /**
     * Creates new form CRUD_Talla
     */
    public CRUD_Talla(int claseSeleccionada) {
        initComponents();
        traerTallas(claseSeleccionada);
    }
    
    private void traerTallas(int claseSeleccionada){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Agregar Talla");

        btnAgregar.setText("Agregar Talla");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(27, 27, 27)
                .addComponent(cmbtalla, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(31, 31, 31)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CRUD_Talla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CRUD_Talla(2).setVisible(true);
            }
        });
    }
    
    public static List<Integer>tallas;
